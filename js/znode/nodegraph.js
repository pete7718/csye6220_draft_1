...
//  var win = $(window);
  ...
  canvas.append("<ul id='menu'><li>Left<\/li><li>Right<\/li><li>Top<\/li><li>Bottom<\/li><\/ul>");		// Pop out menu
  var menu = $("#menu");
...
//    mouseY = e.pageY - topHeight;
    mouseX = e.pageX - (canvas.width() * 0.63);									// Jerry 416px
    mouseY = e.pageY - topHeight - (canvas.height() * 0.21);			// Jerry 160px
  }).mouseup(function(e){
    overlay.hide();
    var creatingNewNode = newNode;
    
//    hitConnect.css({"left":mouseX - 5, "top":mouseY + topHeight - 5});
    hitConnect.css({"left":mouseX, "top":mouseY + topHeight});		// Jerry
  ...
  function Node(xp, yp, w, h, noDelete, forceId){				// End at line 475
...
//              "font-size" : "7px", "background-color" : "gray", "z-index" : 100});
      ex.css({"position":"absolute",
      	      "padding-right" : 0, "padding-top" : 0, "padding-left" : 0, "padding-bottom" : 0,
              "color" : "white",
              "height" : "0px",
              "top" : -4, "left": 0, "cursor": "pointer",
              "font-size" : "7px", "background-color" : "gray", "z-index" : 100});								// Jerry
...
//      point.y = nLoc.top - topHeight + loc.top + 5;
      point.y = nLoc.top - topHeight + loc.top + 5 + 40;		// Jerry
      return point;
    }
...
//      var y = loc.top + nLoc.top - topHeight + 5;
      var y = loc.top + nLoc.top - topHeight + 5 + 40;		// Jerry
      newNode = true;
      
      var id = setInterval(function(){
//        link.attr("path","M " + x + " " + y + " L " + mouseX + " " + mouseY);
        link.attr("path","M " + x + " " + y + " L " + mouseX + " " + (mouseY + 30));		// Jerry
        
        pathEnd.x = mouseX;
//        pathEnd.y = mouseY;
        pathEnd.y = mouseY - 5;		// Jerry
